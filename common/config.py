...
"""
FUND_STORE = (
    "https://funding-service-design-fund-store-test.london.cloudapps.digital"
)
...
FRONTEND = "https://fsd:fsd@frontend.test.gids.dev" # noqa
FORMS = "https://fsd:fsd@forms.test.gids.dev" # noqa
